...
class Deploy {
    ...
    void run(context) {
        ...
        script.echoer.input("Please approve deploy to ${context.config.job.deployKubernetesCluster} Kubernetes cluster. Can be approved by ${deployApprovers} or any from Jenkins admins.")
